(function () {
    ...
    function ControlController($state, $localStorage, messageShow, $timeout) {
        ...
        var client = new Paho.MQTT.Client("m23.cloudmqtt.com", 12908, "web_" + parseInt(Math.random() * 100, 10));
        var client2 = new Paho.MQTT.Client("m23.cloudmqtt.com", 11464, "web_" + parseInt(Math.random() * 100, 10));
